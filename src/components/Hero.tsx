  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          I&apos;m an aspiring designer & developer crafting beautiful, functional websites and applications with a focus on user experience, minimalism and modern aesthetics.
        </p>
      </div>
